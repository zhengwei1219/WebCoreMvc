...
namespace Workflows.DAO
{
	...
	{
        ApprovalSolutionDao _solutionDao;
        ApprovalRecordDao _recordDao;
        ApprovalCommentDao _commentDao;
        ApprovalAssignmentDao _assignmentDao;
        ApprovalAgentDao _agentDao;
        internal NHApprovalService(ApprovalSolutionDao solutionDao,
             ApprovalRecordDao recordDao,
             ApprovalCommentDao commentDao,
              ApprovalAssignmentDao assignmentDao,
              ApprovalAgentDao agentDao)
        {
            _solutionDao = solutionDao;
		...
		{
			return _solutionDao.Save(solution);
		}
		/// <summary>
		/// Saves the solution.
		/// </summary>
		...
		{
			return _solutionDao.Update(solution);
		}
		/// <summary>
		/// Gets the solution.
		/// </summary>
		...
		{
			return _solutionDao.GetById(id, false);
		}
		/// <summary>
		/// 获取某立项的审批信息
		/// </summary>
		...
		{
			return _solutionDao.GetSolution(workflowName, eaId);
		}
		...
		{
			return _solutionDao.GetSolution(instanceId);
		}
		/// <summary>
		/// 按实例Id删除审批意见记录
		/// </summary>
		...
		{
			List<ApprovalSolution> solutions = _solutionDao.GetSolution(instanceId);
			for (int i = solutions.Count - 1; i >= 0; i--)
			{
                _solutionDao.Delete(solutions[i]);
			}
		}
		/// <summary>
		/// 删除审批意见信息
		...
		{
			return _commentDao.GetUserCommentInfo(userId, approvalType);
		}
		...
		{
			return _commentDao.GetCommentInfo(commentInfo, userId, approvalType);
		}
		...
		{
			_commentDao.DeletebyId(commentId);
		}
		...
		{
			return _commentDao.Save(comment);
		}
		#endregion
		...
		{
			return GetAssignmentDao().Save(assignment);
		}
		/// <summary>
		...
		{
			return GetAssignmentDao().Update(assignment);
		}
		/// <summary>
		/// 获取某用户的专办信息
		/// </summary>
		...
		{
			List<ApprovalAssignment> assignments = _assignmentDao.GetAssignment(instanceId);
			for (int i = assignments.Count-1; i >=0; i--)
			{
				_assignmentDao.Delete(assignments[i]);
			}
		}
		#endregion
		...
		{
			return GetAgentDao().Save(agentInfo);
		}
		...
		{
			return GetAgentDao().Update(agentInfo);
		}
		/// <summary>
		/// 按Id删除委托代办信息
		/// </summary>
